...
Revision ID: 98bf1cfd3ba5
Revises: 
Create Date: 2017-08-18 18:12:10.762372
...
def upgrade():
    ...
    sa.Column('linkin', sa.String(length=500), nullable=True),
    sa.Column('duty', sa.String(length=500), nullable=True),
    ...
    sa.Column('trainers', sa.String(length=150), nullable=True),
